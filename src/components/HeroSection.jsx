...
const HeroSection = () => {
  return (
    <div>
      <h1 className="flex text-6xl text-center justify-center font-kumbh-sans-bold mt-10 text-white ">
        <div
      ...
      <div className="flex justify-center items-center mt-3 text-sm text-center">
        <h3 className="max-w-[42rem] text-base text-[#E6E6E6]">
      ...
      <div className="text-center text-[#8D8D8D] text-sm mt-4 flex justify-center space-x-3 items-center">
        No credit card required &nbsp;<span><PiStarFourFill color="white"/></span>&nbsp;FREE 14-day trial
      </div>
    </div>
  );
};
