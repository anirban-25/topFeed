...
const Page = () => {
  ...
  const tiers = [
    ...
    },
    {
      ...
      lemonSqueezyMonthlyUrl:
        `https://topfeed.lemonsqueezy.com/buy/c9908381-4dac-4539-ae62-d6eadf10bddf?media=0&discount=0&metadata[user_id]=${userId}`,
      lemonSqueezyYearlyUrl:
        `https://topfeed.lemonsqueezy.com/buy/74c9438d-2424-4e0e-920e-f29c5912852b?media=0&discount=0&metadata[user_id]=${userId}`,
    },
    {
      name: "Scale",
      monthlyPrice: 149,
      ...
      lemonSqueezyMonthlyUrl:
        `https://topfeed.lemonsqueezy.com/buy/e434c319-7b78-4449-8a5c-2514cc1832a6?media=0&discount=0&metadata[user_id]=${userId}`,
      lemonSqueezyYearlyUrl:
        `https://topfeed.lemonsqueezy.com/buy/5e76b568-a6df-4404-af3d-da5137f029aa?media=0&discount=0&metadata[user_id]=${userId}`,
    },
  ];
